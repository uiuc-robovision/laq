...
_C.LOG_SIGMA = False
_C.NO_VAR_DECAY = False
_C.NO_VAR_DECAY = False
_C.SOFTPLUS_REWARD_VARIANCE = -10.0
_C.SOFTPLUS_LOWER_BOUND=0.0
_C.MODEL_INITILIZATION=''
_C.MULTI_TASK=False
_C.MULTI_TASK_15ENV=False
_C.SLAM_ACTIONS=False
_C.NUM_SLAM_ACTIONS=4
_C.D4RL=False
_C.AVERAGED_DQN_K=0
_C.ENSEMBLE_COUNT=0
_C.AVERAGED_DQN_MIN=False
_C.POSITIONAL_ENCODING=False
_C.ARCH_DIM=128
_C.TCC=False
